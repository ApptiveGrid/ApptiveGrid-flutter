  ...
  group('Parsing', () {
    ...
    test('From Generated Uri String matches original', () {
      final direct = DirectFormUri(
          user: '123456', space: 'asdfg', grid: '1a2s3d4f', form: '787878');
  ...
  group('Equality', () {
    ...
    test('Different Values do not equal', () {
      ...
      final two = DirectFormUri(
          user: '123456', space: 'asdfg', grid: '1a2s3d4f', form: '878787');
  ...
  group('Entity', () {
    test('With Entity reflects in uri', () {
      final entityUri = EntityUri(
          user: '123456', space: 'asdfg', grid: '1a2s3d4f', entity: '909090');
      final direct = DirectFormUri(
              user: '123456', space: 'asdfg', grid: '1a2s3d4f', form: '787878')
