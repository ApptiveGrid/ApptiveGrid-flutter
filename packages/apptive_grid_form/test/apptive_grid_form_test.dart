...
void main() {
  ...
  setUpAll(() {
    ...
    registerFallbackValue(ActionItem(action: FormAction('', ''), data: FormData(title: '', components: [], schema: null)));
  });
    ...
    group('Action Error', () {
      ...
      testWidgets('Cache Response. Additional Answer shows Form',
          (tester) async {
            ...
            when(() => client.options).thenAnswer((invocation) => ApptiveGridOptions(cache: cache));
        final target = TestApp(
          client: client,
          child: ApptiveGridForm(
            formUri: RedirectFormUri(
  ...
  group('Current Data', () {
      testWidgets('Current Data returns data', (tester) async {
        ...
        expect((tester.state(find.byType(ApptiveGridForm)) as ApptiveGridFormState).currentData, equals(form));
      });

      testWidgets('Action Success '
        ...
        expect((tester.state(find.byType(ApptiveGridForm)) as ApptiveGridFormState).currentData, equals(null));
      });

      testWidgets('Action Error '
        ...
        expect((tester.state(find.byType(ApptiveGridForm)) as ApptiveGridFormState).currentData, equals(formData));
      });
  });
}
