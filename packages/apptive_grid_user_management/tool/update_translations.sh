...
for lang in "en" "de"; do
  ...
  printf "// ignore_for_file: public_member_api_docs, prefer_single_quotes\n" >"$langFile"
  printf "// coverage:ignore-file\n\n" >>"$langFile"
  printf "import 'package:apptive_grid_user_management/src/translation/apptive_grid_user_management_translation.dart';\n\n" >>"$langFile"
  printf "class ApptiveGridUserManagementLocalizedTranslation extends ApptiveGridUserManagementTranslation {\n" >>"$langFile"
  printf "  const ApptiveGridUserManagementLocalizedTranslation() : super();\n" >>"$langFile"
